...
| `inwangsan` | 인왕산 | Inwangsan Mountain | fog / clear |
| `gyeongui-forest` | 경의선숲길공원 | Gyeongui Line Forest Park | partly-cloudy |
| `gwanaksan` | 관악산 | Gwanaksan | overcast / cloud sea |
| `naksan-fortress` | 낙산 성곽길 | Naksan Fortress Wall | clear / sunset |
...
The starter batch — one pass covering all 9 landmarks and all 6 conditions with a
day/night mix. Full prompts as submitted (camera move in **bold**):

1. **`hangang-park__clear__day`** · kling2_6 — *Low gliding camera* over Han River
   Park on a bright clear sunny day. Riverside grass lawns and walking paths, the
   wide sparkling Han River, a long bridge spanning it, modern apartment towers and
   blue sky with a few drifting clouds beyond. Smooth steady forward glide low over
   the riverbank. + suffix.
...
3. **`cheonggyecheon__rain__night`** · kling2_6 — *Low tracking shot* gliding along
   ...
   + suffix.
4. **`inwangsan__fog__day`** · kling2_6 — *Slow reveal* of Inwangsan Mountain
   shrouded in thick drifting fog at dawn. Rugged granite rock faces and ridgelines,
   scattered pine, fragments of the old grey Seoul fortress wall, mist rolling
   between peaks, soft pale light. Steady forward drift through the fog. + suffix.
...
6. **`gwanaksan__overcast__day`** · kling2_6 — *Slow aerial drift* above a cloud sea
   from Gwanaksan Mountain south of Seoul on a heavily overcast day: a vast sea of
   low grey clouds, distant ridgelines emerging like islands, rocky summit outcrops
   and windswept pine in the foreground, brooding diffuse daylight. + suffix.
7. **`naksan-fortress__clear__day`** · kling2_6 — *Sweeping shot gliding alongside*
   the Naksan Fortress Wall climbing the grassy ridge of Naksan at golden hour under
   a clear sky. Weathered grey stone battlements winding up the hill, warm low
   sunlight raking the stone, Seoul cityscape glowing below. + suffix.
...
| inwangsan | day · night | day · night | day · night | day · night | day · night | ★ day `[done]` · night |
| gyeongui-forest | day · night | ★ day `[done]` · night | day · night | day · night | day · night | day · night |
| gwanaksan | day · night | day · night | ★ day `[done]` · night | day · night | day · night | day · night |
| naksan-fortress | ★ day `[done]` · night | day · night | day · night | day · night | day · night | day · night |
